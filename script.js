...
var a = ["blue", "violet", "cyan", "aquamarine", "cornsilk", "maroon", "pink", "yellow", "goldenrod", "green"]
a.forEach(function(color){  $("#element").clone().css({background: color}).appendTo(elementsList)})